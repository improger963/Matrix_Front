...
import { Award, CheckCircle, Gift, Network, Rocket, ShieldCheck, Target, Users, UserPlus, DollarSign, Share2, GraduationCap, Megaphone, ListTodo, BotMessageSquare, Video, BookText, Edit3, MessageSquare, Star, Building } from 'lucide-react';
...
export const MOCK_TYCOON: Tycoon = {
    ...
    referralLink: 'https://realty-guilds.app/join?ref=U12345',
    joinDate: '2024-06-01',
    welcomeMessage: 'Привет! Меня зовут Алексей, и я помогу тебе стартовать в Realty Guilds. Присоединяйся к моей Гильдии, и давай строить империю вместе!',
    bio: 'Эксперт по построению больших команд. Помогу каждому партнеру выйти на доход от 1000 ГК в первый месяц.',
    socials: {
...
export const MOCK_ACHIEVEMENTS: Achievement[] = [
    ...
    { id: 'ach02', title: 'Первый Инвестор', description: 'Вы привлекли своего первого инвестора.', icon: Users, unlocked: true, category: 'Guild' },
    { id: 'ach03', title: 'Ядро Гильдии', description: 'Пригласите 10 личных инвесторов в свою Гильдию.', icon: Target, unlocked: true, progress: { current: MOCK_TYCOON.investors, target: 10 }, category: 'Guild' },
    { id: 'ach04', title: 'Застройщик', description: 'Завершите свой первый Проект (участок).', icon: ShieldCheck, unlocked: true, category: 'Personal' },
    { id: 'ach05', title: 'Мастер-Строитель', description: 'Завершите 5 Проектов.', icon: Building, unlocked: false, progress: { current: MOCK_TYCOON.projectsCompleted, target: 5 }, category: 'Personal' },
    { id: 'ach06', title: 'Рост Гильдии', description: 'Ваша гильдия достигла 25 человек.', icon: Network, unlocked: false, progress: { current: 18, target: 25 }, category: 'Guild' },
    { id: 'ach07', title: 'Первая Аренда', description: 'Заработайте свои первые 100 Городских Кредитов.', icon: Gift, unlocked: true, category: 'Financial' },
    { id: 'ach08', title: 'Капиталист', description: 'Достигните баланса в 1000 Городских Кредитов.', icon: CheckCircle, unlocked: true, progress: { current: MOCK_TYCOON.cityCredits, target: 1000 }, category: 'Financial' },
];
...
export const MOCK_NOTIFICATIONS: Notification[] = [
    ...
    },
    {
        ...
        description: 'Вы успешно сдали проект "Участок" и получили арендную плату.',
    ...
    },
    {
        ...
        icon: DollarSign,
        title: 'Продажа ГК',
        description: 'Ваш запрос на продажу 50.00 ГК был успешно обработан.',
    ...
    },
    {
        ...
        description: 'Вы разблокировали достижение "Ядро Гильдии".',
...
export const MOCK_REVIEWS: Review[] = [
    {
        ...
        rating: 5,
        text: "Проект просто супер! Уже через неделю вышла на первый серьезный доход. Все прозрачно и понятно, гильдия всегда помогает. Рекомендую всем, кто хочет изменить свою жизнь!",
    ...
    },
    {
        ...
        rating: 5,
        text: "Сначала сомневался, но решил попробовать. Не жалею! Система 'городских контрактов' реально работает, даже новичку легко стартовать. Техподдержка отвечает быстро, что очень радует.",
    ...
    },
    {
        ...
        rating: 4,
        text: "В целом, все нравится. Чтобы хорошо зарабатывать, нужно активно работать и строить гильдию, это не кнопка 'бабло'. Но если приложить усилия, результат будет.",
    ...
    },
    {
        ...
        rating: 5,
        text: "Очень удобный личный кабинет, все интуитивно понятно. AI-копирайтер - это вообще пушка! Помогает создавать крутые посты для привлечения инвесторов.",
...
export const MOCK_NEWS: NewsArticle[] = [
    {
        id: 'NEWS001',
        title: '🎉 Грандиозный запуск "Realty Guilds"!',
        content: 'Мы рады объявить об официальном старте нашего проекта! Присоединяйтесь к нам сегодня, чтобы стать частью революции в мире экономических игр. Первые Магнаты получат эксклюзивные бонусы!',
        timestamp: '2024-07-25',
    },
    {
        id: 'NEWS002',
        title: '📈 Внедрение новой платежной системы в Банке',
        content: 'Для вашего удобства мы добавили возможность покупки и продажи Городских Кредитов (ГК) через банковские карты. Теперь финансовые операции стали еще проще и доступнее.',
        timestamp: '2024-07-22',
    },
    {
        id: 'NEWS003',
...
export const MOCK_ACADEMY_ARTICLES: AcademyArticle[] = [
    ...
    { id: 'A005', title: 'Как создать личный бренд Магната', category: 'Продвижение', type: 'video', duration: '18:05', coverUrl: 'https://images.unsplash.com/photo-1588196749597-9ff075a6b54a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=60', isLocked: true, xpReward: 150, isCompleted: false, content: 'Доступно на 5-м уровне. Узнайте, как стать человеком, в чью Гильдию хотят присоединиться. Мы поговорим о позиционировании, контенте и вовлечении аудитории.' },
    { id: 'A006', title: 'Финансовая грамотность для Магната', category: 'Для новичков', type: 'article', coverUrl: 'https://images.unsplash.com/photo-1642792962358-83132a2e475c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=60', isLocked: false, xpReward: 60, isCompleted: false, content: 'Заработать Городские Кредиты — это полдела. Важно правильно ими распоряжаться. В этой статье вы узнаете об основах финансовой безопасности, реинвестировании и планировании своего бюджета для достижения максимальных результатов в игре.' },
];
...
export const MOCK_ALL_TASKS: DailyTask[] = [
    ...
    { id: 'O02', category: 'onboarding', title: 'Изучить основы', subtitle: 'Путь новичка: Шаг 2', description: 'Прочтите раздел "Как это работает", чтобы понять ключевые механики игры.', reward: 25, icon: GraduationCap, isCompleted: true, actionText: 'Читать', actionType: 'navigate', target: 'howitworks' },
    { id: 'O03', category: 'onboarding', title: 'Поздороваться с гильдией', subtitle: 'Путь новичка: Шаг 3', description: 'Напишите приветственное сообщение в общем чате. Будьте активны!', reward: 15, icon: MessageSquare, isCompleted: false, actionText: 'Перейти в чат', actionType: 'navigate', target: 'chat' },
    ...
    // Special Tasks
    { id: 'S01', category: 'special', title: 'Контракт "Лидер"', subtitle: 'Ограничено по времени', description: 'Пригласите 3-х активных инвесторов за первую неделю и получите эксклюзивный бонус на баланс.', reward: 150, icon: Rocket, isCompleted: false, actionText: 'Подробнее', actionType: 'none', progress: { current: 1, target: 3 } },
    { id: 'S02', category: 'special', title: 'Контракт "Обратная связь"', description: 'Ваше мнение помогает нам стать лучше. Оставьте честный отзыв об игре и получите награду.', reward: 100, icon: Star, isCompleted: false, actionText: 'Оставить отзыв', actionType: 'navigate', target: 'reviews' },
];
...
export const MOCK_PROMO_MATERIALS: PromoMaterial[] = [
    ...
    { id: 'P03', type: 'text', title: 'Текст для Telegram', content: `🔥 **Готов построить свою империю?** 🔥

Надоело работать "на дядю"? Ищешь способ зарабатывать онлайн, но не знаешь, с чего начать?

У меня есть решение! **Realty Guilds** — это не просто игра, это твой шанс построить собственный бизнес с минимальными вложениями.

✅ Прозрачная экономика
✅ Мощная гильдия и поддержка 24/7
✅ Автоматизированная система "Филиалов" и "Городских контрактов"

Не упусти свой шанс! Напиши мне "ХОЧУ В ГИЛЬДИЮ", и я расскажу все подробности. 👇`},
    { id: 'P04', type: 'text', title: 'Короткое сообщение для WhatsApp', content: `Привет! 👋 Я сейчас развиваю очень интересный игровой проект с отличным доходом. Подумал(а), тебе тоже может быть интересно. Если ищешь новые возможности, дай знать, расскажу подробнее!` },
];

export const PINNED_CHAT_MESSAGE: ChatMessage = {
    id: 'MSG_PINNED',
    user: MOCK_USERS_DB['L1'],
    text: '🚀 Внимание, Магнаты! В эту субботу в 18:00 МСК состоится вебинар по новым стратегиям застройки районов. Явка обязательна для всех, кто хочет удвоить свой доход! Ссылка будет здесь за час до начала.',
...
export const MOCK_CHAT_MESSAGES: ChatMessage[] = [
    {
        id: 'MSG001',
        user: MOCK_USERS_DB['L1'],
        text: 'Всем привет! Отличный день для завершения проектов!',
    ...
    },
    {
        ...
        text: 'Я на 4-м, почти достроила Участок. Нужно еще одно место. Кстати, кто-нибудь пробовал новый AI-генератор баннеров?',
        timestamp: new Date(Date.now() - 8 * 60 * 1000).toISOString(),
    },
    {
        id: 'MSG004',
        user: MOCK_USERS_DB['U12345'], // This is our main user
        text: 'Да, @Мария, я тестировал. Очень крутая штука, экономит кучу времени. Сделал себе пару баннеров для сторис. https://realty-guilds.app/promo',
    ...
    },
    {
        id: 'MSG006',
        user: MOCK_USERS_DB['L2'],
        text: 'Показываю скрин своей вчерашней арендной платы, чтобы всех замотивировать! 💪',
...
export const CHAT_RULES = [
    { title: 'Будьте вежливы', content: 'Относитесь ко всем Магнатам с уважением. Оскорбления, троллинг и разжигание конфликтов строго запрещены.' },
    ...
    { title: 'По теме игры', content: 'Придерживайтесь тематики Realty Guilds. Делитесь успехами, задавайте вопросы, помогайте новичкам.' },

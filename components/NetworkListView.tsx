...
const MemberCard: React.FC<{ member: Partner }> = ({ member }) => {
    return (
...
const NetworkListView: React.FC = () => {
    ...
    const filteredAndSortedTeamMembers = useMemo(() => {
         const filtered = MOCK_NETWORK_MEMBERS
    ...
    return (
        <Card>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                <div>
                    <h3 className="text-xl font-bold text-white">Партнеры моей Бизнес-сети</h3>

...
const faqData = [
    ...
    {
        question: "Что такое 'Транши от Бизнес-сети'?",
        answer: "'Транши' — это когда партнеры от ваших вышестоящих лидеров попадают в вашу структуру, помогая вам быстрее достичь Полного Финансирования. Это ключевой элемент командной работы в Nexus Capital."
    }
];

...
import { Megaphone, Image as ImageIcon, FileText, Download, Copy, Check, Sparkles, LoaderCircle } from 'lucide-react';
...
const AIBannerGenerator: React.FC = () => {
    ...
    const loadingMessages = [
        "Искусственный интеллект подбирает пиксели...",
        "Создаем визуальный шедевр...",
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card className="!bg-dark-800/50">
                <h3 className="text-xl font-bold text-white mb-4">1. Настройте генерацию</h3>
                <div className="space-y-4">
                    <div>
                        <label htmlFor="prompt" className="block text-sm font-medium text-gray-300 mb-1">Опишите баннер</label>
                        <textarea
                            id="prompt"
                            value={prompt}
            ...
            <Card className="!bg-dark-800/50 min-h-[300px] flex items-center justify-center">
                {isLoading ? (
                    <div className="text-center">
                        <LoaderCircle className="h-12 w-12 text-brand-primary animate-spin mx-auto" />
                        <p className="mt-4 font-semibold text-white">{loadingMessage}</p>
                    </div>
                ) : generatedImage ? (
                    <div className="w-full text-center">
                        <h3 className="text-xl font-bold text-white mb-4">2. Результат</h3>
                        <img src={generatedImage} alt="Сгенерированный баннер" className="w-full h-auto object-contain rounded-lg mb-4 max-h-80" />
                    ...
                    <div className="text-center text-gray-500">
                        ...
                        <p>Здесь появится ваш сгенерированный баннер</p>
                    </div>
                )}
            </Card>
        </div>

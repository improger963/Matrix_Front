...
import { MOCK_SYNDICATE_MEMBERS as MOCK_NETWORK_MEMBERS, MOCK_ACHIEVEMENTS } from '../constants.ts';
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="animate-fade-in">
                ...
                {activeTab === 'achievements' && <NetworkAchievementsView achievementStats={achievementStats} />}
            </div>
        </div>
    );
};

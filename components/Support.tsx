            ...
            <div className="lg:col-span-1">
                 <Card className="animate-slide-in-up" style={{ animationDelay: '200ms' }}>
                    ...
                    <div className="space-y-3">
                         <a href="mailto:support@nexus-capital.app" className="flex items-center gap-3 p-3 bg-dark-700/50 hover:bg-dark-700 rounded-lg transition-colors">
                            <Mail className="h-6 w-6 text-brand-accent"/>
                            <div>
                                <p className="font-semibold text-white">Email</p>
                                <p className="text-xs text-gray-400">support@nexus-capital.app</p>
                            </div>
                        </a>
                        <a href="https://t.me/nexus_capital_support" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-dark-700/50 hover:bg-dark-700 rounded-lg transition-colors">
                            <MessageSquare className="h-6 w-6 text-brand-accent"/>
                             <div>
                                <p className="font-semibold text-white">Telegram</p>
                                <p className="text-xs text-gray-400">@nexus_capital_support</p>
                            </div>
                        </a>
                    </div>
